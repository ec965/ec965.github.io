...
import {CoffeeGrams} from './projects';
//routing
import {
  HashRouter,
  Switch,
  ...
  return(
    <HashRouter>
      ...
      <Switch>
        ...
        <Route path={`${path}/boulderField`} component={() => {  
          window.location.href = 'https://ec965.github.io/MP-Recs/index.html'; 
          return null;
        }}/>
        <Route path={`${path}/coffeeGrams`}>
          <CoffeeGrams/>
        </Route>
      </Switch>
    </HashRouter>
