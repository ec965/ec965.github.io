import{$ as e,A as t,q as o,r,G as a,S as i,a as s,L as n,b as l,H as c,c as p,R as m,d}from"./vendor.0228ed36.js";const h={lrSpacing:"10vw",colors:{main:"#000",secondary:"#FFF",highlight:"#cf4868",grey:"#808080"},fontSize:{h1:"32px",h2:"26px",h3:"22px",p:"18px"},fontFamily:{monospace:'"Lucida Console", "Courier New", monospace',sansSerif:"Arial, Verdana, Helvetica"},screenSize:{mobile:"(max-width: 600px)",tablet:"(max-width: 1100px)"},hover:{opacity:"60%",time:"0.3s"}},u=(e,t)=>parseInt(e)-t+"px",g=e`
  body {
...
`,I=()=>r.exports.createElement(S,{id:"header"},r.exports.createElement(v,null,r.exports.createElement("h2",null,"Enoch Chau")),r.exports.createElement(v,{monospace:!0},r.exports.createElement(n,{to:"/"},r.exports.createElement("h2",null,"Projects")),r.exports.createElement(n,{to:"/about"},r.exports.createElement("h2",null,"About")))),C=t`
...
`,A=({media:e})=>{const[t,o]=r.exports.useState(e.length>0?e[0]:{src:"",alt:"N/A"});return r.exports.createElement(_,null,r.exports.createElement(B,null,"alt"in t?r.exports.createElement(M,{src:t.src,alt:t.alt}):t.src.includes("youtube.com")?r.exports.createElement(j,null,r.exports.createElement("iframe",{title:t.title,src:t.src,frameBorder:"0",allow:"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0})):r.exports.createElement($,{controls:!0},r.exports.createElement("source",{src:t.src})),r.exports.createElement("p",null,"alt"in t?t.alt:t.title)),e.length>1&&r.exports.createElement(G,null,e.map((e=>{const t="thumbnail"in e?e.thumbnail:e;return r.exports.createElement(F,{key:t.src,src:t.src,alt:t.alt,onClick:()=>o(e)})}))))},J=o.img`
  width: ${e=>e.width||""};
  height: ${e=>e.height||""};
